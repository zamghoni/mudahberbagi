        ...
        <div class="billing-address">
          ...
          <form id="contact-form" class="contact-address" action="<?php echo site_url('haldonasi/simpan'); ?>" method="POST">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control"  required oninvalid="this.setCustomValidity('Nominal Harus Di Isi')" oninput="setCustomValidity('')" placeholder="Nominal" name="nominal">
            </div>
