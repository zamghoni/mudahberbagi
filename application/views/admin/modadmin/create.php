        ...
        <div class="widget-main no-padding">
          ...
          <form method="post" action="<?php echo site_url('admin/save') ?>">
            <fieldset>
              ...
              <label>HP</label><br>
              <input type="number" name="hp_admin" class="form-control" placeholder="Masukan Nomor HP admin" value="" required oninvalid="this.setCustomValidity('Nomor HP admin Harus Di Isi')" oninput="setCustomValidity('')" onKeyPress="return isNumberKey(event)"><p></p>
