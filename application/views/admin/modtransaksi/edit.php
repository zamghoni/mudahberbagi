...
<div class="widget-main no-padding">
  ...
  <input type="text" name="nominal" class="form-control" placeholder="Masukan Nominal" value="<?php echo $data['nominal'] ?>" required oninvalid="this.setCustomValidity('Nominal Harus Di Isi')" oninput="setCustomValidity('')"><p></p>
