...
<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo $row['id_transaksi']; ?>">
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                          					...
                          					<td>
                          						<div class="hidden-sm hidden-xs btn-group">
                          							<a href="<?php echo site_url('transaksi/delete/' . $row['id_transaksi']) ?>" class="btn btn-danger" title="Delete" onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['judul_donasi']; ?>')">Hapus
                          							</a>
                          							</div>
                          						</td>
                          					</tr>
