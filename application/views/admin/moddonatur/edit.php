        ...
        <div class="widget-main no-padding">
          ...
          <form method="post" action="<?php echo site_url('donatur/update/'.$data['kode_donatur']) ?>" enctype="multipart/form-data">
            <fieldset>
              ...
              <input type="text" name="pswd_donatur" class="form-control" placeholder="Masukan jika password donatur akan diubah" oninvalid="this.setCustomValidity('Password Donatur Harus Di Isi')" oninput="setCustomValidity('')"><p></p>
