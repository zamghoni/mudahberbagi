...
<!--Form-->
  ...
  <input type="text" name="hp_donatur" class="form-control" placeholder="Masukan No HP Donatur" value="" required oninvalid="this.setCustomValidity('No HP Donatur Harus Di Isi')" oninput="setCustomValidity('')"><p></p>

  <label>Email Donatur</label><br>
  <input type="text" name="email_donatur" class="form-control" placeholder="Masukan Email Donatur" value="" required oninvalid="this.setCustomValidity('Email Donatur Harus Di Isi')" oninput="setCustomValidity('')"><p></p>

  <label>Foto Donatur</label><br>
  <input type="file" name="img_donatur" required><p></p>
