...
<textarea name="isi_donasi" class="form-control ckeditor" id="ckeditor" placeholder="isi Donasi" required oninvalid="this.setCustomValidity('Judul Donasi Harus Di Isi')" oninput="setCustomValidity('')" rows="4"></textarea>

<label>Foto Donasi</label><br>
<input type="file" name="img_donasi" required oninvalid="this.setCustomValidity('Judul Donasi Harus Di Isi')" oninput="setCustomValidity('')"><p></p>

<div class="form-actions center">
<button class="btn btn-info" type="submit"><i class="ace-icon fa fa-check bigger-110"></i>Simpan</button>
<a href="<?php echo site_url('donasi') ?>"><button class="btn btn-warning" type="button"><i class="ace-icon fa fa-undo bigger-110"></i>Batal</button></a>
</div>
</fieldset>
</form>
<!--EndForm-->
